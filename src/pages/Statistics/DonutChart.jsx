...
function DonutChart() {
  ...
  useEffect(() => {
    if (data) {
      const donut = data.donutChartdata;
      const total = donut.reduce((acc, item) => acc + item, 0);
      let [a1, a2, a3] = donut;
      setStatistics(data.donutChartdata[0]);

      a1 = (a1 / total) * 100;
      a2 = (a2 / total) * 100;
      a3 = (a3 / total) * 100;

      const [a1Label, a2Label, a3Label] = data.donutChartlabel;

      const displayOptions = [
        {
          stats: data.donutChartdata[0],
          label: a1Label,
          color: "#5d44a2",
          width: "35",
        },
        {
          stats: data.donutChartdata[1],
          label: a2Label,
          color: "#B6A4E5",
          width: "30",
        },
        {
          stats: data.donutChartdata[2],
          label: a3Label,
          color: "#E2DBF6",
          width: "25",
        },
